...
def main():
    ...
    header = read_file(join(folder, "rfmix_reader", "fb_reader.h"))
    source = read_file(join(folder, "rfmix_reader", "fb_reader.c"))
    ...
    ffibuilder.set_source("rfmix_reader.fb_reader", source, language="c")
    return ffibuilder
