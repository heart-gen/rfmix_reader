...
def _read_fb_chunk(buff, nrows, ncols, row_start, row_end, col_start, col_end):
    ...
    read_fb_chunk_kernel[blocks_per_grid, threads_per_block](
        ...
        d_out, cp.asarray(strides), (ncols + 3) // 4
    )
...
extern "C" __global__
void unpack_chunk_kernel(uint8_t *buff, uint64_t nrows, uint64_t ncols,
...
#     """
#     r = blockIdx.y * blockDim.y + threadIdx.y + row_start
#     c = blockIdx.x * blockDim.x + threadIdx.x + col_start
